    ...
    for (let i = 0; i < particles.length; i++) {
        for (let j = i + 1; j < particles.length; j++) {
            ...
            if (distance < 150) {
                ...
                ctx.strokeStyle = `rgba(8, 216, 201, ${0.15 * (1 - distance / 150)})`;
                ctx.lineWidth = 0.5;
                ctx.stroke();
            }
        }
...
// Neural background removed - replaced with simpler gradient background
...
// ==================== Parallax Effect ====================
// Parallax disabled to keep the logo animation fixed in place
function handleParallax() {
    // No parallax effect - logo stays in its original position
}
...
// Counter animation removed - metrics now display static values
    ...
    form.addEventListener('submit', function(e) {
        ...
        setTimeout(() => {
            ...
            successMessage.style.cssText = `
                ...
                left: 50%;
                transform: translate(-50%, -50%);
                background: linear-gradient(135deg, rgba(8, 216, 201, 0.95), rgba(6, 184, 171, 0.95));
                color: #0B1221;
                padding: 40px 60px;
                border-radius: 20px;
                box-shadow: 0 20px 60px rgba(8, 216, 201, 0.4);
                text-align: center;
                z-index: 10000;
            ...
            successMessage.innerHTML = `
                ...
                <div style="font-family: 'Satoshi', sans-serif; font-size: 24px; font-weight: 700; margin-bottom: 8px;">Thank You!</div>
                <div style="font-size: 16px; font-family: 'Montserrat', sans-serif; font-weight: 400; opacity: 0.9;">We'll get back to you soon.</div>
            `;
            ...
            setTimeout(() => {
                ...
                successMessage.style.animation = 'successPopIn 0.3s cubic-bezier(0.4, 0, 1, 1) reverse';
                setTimeout(() => {
